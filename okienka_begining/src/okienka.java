 ...
 * @author llser
 */
public class okienka extends javax.swing.JFrame {

    /**
     * Creates new form okienka
     */
    public okienka() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(okienka.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
